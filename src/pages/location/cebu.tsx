            ...
            <div className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-2xl p-8 mb-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl mb-6 opacity-90">
                  {currentLanguage === 'ko' && '세부 최고의 아파트를 찾아보세요. 아일랜드 파라다이스에서의 생활.'}
                  {currentLanguage === 'zh' && '找到宿务最好的公寓。在岛屿天堂中生活。'}
                  {currentLanguage === 'ja' && 'セブ最高のアパートを見つけてください。アイランドパラダイスでの生活。'}
                  {currentLanguage === 'en' && 'Find the best apartments in Cebu. Island paradise living at its finest.'}
                </p>
